...
class Static:
    ...
    def infomation_card(
        ...
        components.html(
            ...
            <style>
                ...
                .battery-fill-1{{
                    background-color: {batter1_color};
                }}
                
                .battery-fill-2{{
                    background-color: {batter2_color};
                }}
            ...
            <div class="container">
                ...
                <div class="info"> Motor Model: {motor_name}
                </div>
                ...
                <div class="info status">
                    ...
                    <div class="condition-light">
                    </div>
                </div>

                
                <div class="battery-info">
                    <div class="info battery-text">Battery (Sensor 1):
                    </div>
                    <div class="battery-status">
                        <div class="battery-level">
                            <div class="battery-fill-1 battery-fill">
                            </div>
                            <span class="battery-percentage-1 battery-percentage"></span>
                        </div>
                    </div>
                </div>

                <div class="battery-info">
                    <div class="info battery-text">Battery (Sensor 2):
                    </div>
                    <div class="battery-status">
                        <div class="battery-level">
                            <div class="battery-fill-2 battery-fill">
                            </div>
                            <span class="battery-percentage-2 battery-percentage"></span>
                        </div>
                    </div>
                </div>
            ...
            <script>
                function updateBatteryStatus() {{
                    var batteryFill = document.querySelector(".battery-fill-1");
                    var batteryPercentage = document.querySelector(".battery-percentage-1");
                
                    var fillWidth = Math.round({battery1}) + "%";
                    batteryFill.style.width = fillWidth;
                    batteryPercentage.innerHTML = fillWidth;


                    var batteryFill_2 = document.querySelector(".battery-fill-2");
                    var batteryPercentage_2 = document.querySelector(".battery-percentage-2");
                
                    var fillWidth_2 = Math.round({battery2}) + "%";
                    batteryFill_2.style.width = fillWidth_2;
                    batteryPercentage_2.innerHTML = fillWidth_2;
                }}
    ...
    def gauge_chart_ai(self, value):
        ...
        content = f"""
            <div class="main">
                ...
                <p class="label-1"> Health </p>
                <p class="label-2"> Warn </p>
                <canvas id="demo"></canvas>
                <div id="preview-textfield"></div>
            </div>
        """

        self.make_gauge_chart(setting, style_sheet, content)
        return None
        ...
        setting = f"""
            <script>
                var opts = {{
                    ...
                    labels: [0, 1.8, 4.5, 14.7, 16],
                    fractionDigits: 0
                    }},

                    // static zones
                    staticZones: [
                    {{strokeStyle: "#4CC790", min: 0, max: 1.8}},
                    {{strokeStyle: "#FAFF02", min: 1.8, max: 4.5}},
                    {{strokeStyle: "#F11502", min: 4.5, max: 14.7}},
                    ],
    ...
    @staticmethod
    def make_gauge_chart(setting, style_sheet, content):
        ...
        script = style_sheet + content + script1 + setting
